...
#     2. ORCAMENTO     estourou um dos três tetos              ✗ inconcluso
...
# unidade de consumo — um passo consome entre 300 e 40.000 tokens.
#
...
# ------------------------------------------------------------------ resumo
print(f"\n{LINHA}")
print(f"{'execução':<12} {'término':<22} {'passos':>7} {'tokens':>8}")
