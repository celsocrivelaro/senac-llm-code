...
#
# O CONSUMO ACUMULADO cresce com o quadrado do número de passos: dobrar os
...
#     volta em toda chamada. Em B ela ESTABILIZA — os `MANTER_INTEGROS`
#     resultados mais recentes ficam inteiros, e cada passo antigo vira um
#     marcador de ~30 tokens;
#
...
#     ESCRITAS EXECUTADAS com seus identificadores, os erros já cometidos e
#     os fatos numéricos. Perder o id de uma escrita faz o agente escrever
#     duas vezes — e aí quem salva é a chave de idempotência do script 05.
import json
...
print(f"""
                        passos   tokens de entrada
   sem tool clearing    {a.n_passos:>6}   {total_a:>17}
   com tool clearing    {b.n_passos:>6}   {total_b:>17}
